...
export type SearchUserQuery = (
  ...
  & { search: (
    ...
    & { nodes?: Maybe<Array<Maybe<{ __typename?: 'App' } | { __typename?: 'Discussion' } | { __typename?: 'Issue' } | { __typename?: 'MarketplaceListing' } | { __typename?: 'Organization' } | { __typename?: 'PullRequest' } | { __typename?: 'Repository' } | (
      { __typename?: 'User' }
      & Pick<User, 'id' | 'avatarUrl' | 'login' | 'name'>
    )>>>, pageInfo: (
      { __typename?: 'PageInfo' }
...
export type SearchUserRepositoriesQueryVariables = Exact<{
  login: Scalars['String'];
  first: Scalars['Int'];
  cursor?: Maybe<Scalars['String']>;
}>;
...
export type SearchUserRepositoriesQuery = (
  { __typename?: 'Query' }
  & { repositoryOwner?: Maybe<(
    ...
    & { repositories: (
      ...
      & { nodes?: Maybe<Array<Maybe<(
        { __typename?: 'Repository' }
        & Pick<Repository, 'id' | 'description' | 'name' | 'stargazerCount' | 'url'>
        & { watchers: (
          { __typename?: 'UserConnection' }
...
export const SearchUserRepositoriesDocument = gql`
...
/**
 * __useSearchUserRepositoriesQuery__
 *
 * To run a query within a React component, call `useSearchUserRepositoriesQuery` and pass it any options that fit your needs.
 * When your component renders, `useSearchUserRepositoriesQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useSearchUserRepositoriesQuery({
 *   variables: {
 ...
 * });
 */
export function useSearchUserRepositoriesQuery(baseOptions: Apollo.QueryHookOptions<SearchUserRepositoriesQuery, SearchUserRepositoriesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<SearchUserRepositoriesQuery, SearchUserRepositoriesQueryVariables>(SearchUserRepositoriesDocument, options);
      }
export function useSearchUserRepositoriesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<SearchUserRepositoriesQuery, SearchUserRepositoriesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<SearchUserRepositoriesQuery, SearchUserRepositoriesQueryVariables>(SearchUserRepositoriesDocument, options);
        }
export type SearchUserRepositoriesQueryHookResult = ReturnType<typeof useSearchUserRepositoriesQuery>;
export type SearchUserRepositoriesLazyQueryHookResult = ReturnType<typeof useSearchUserRepositoriesLazyQuery>;
export type SearchUserRepositoriesQueryResult = Apollo.QueryResult<SearchUserRepositoriesQuery, SearchUserRepositoriesQueryVariables>;